...
public class BSettingsTest extends JPanel {
	...
	public BSettingsTest() {
		...
		springLayout.putConstraint(SpringLayout.NORTH, panel, 6, SpringLayout.SOUTH, settings);
		...
		maxVoltage.setModel(new SpinnerNumberModel(new Float(6.0f), new Float(0), new Float(12), new Float(0.1f)));
