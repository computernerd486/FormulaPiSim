...
public class ViewPort extends JPanel {
	...
	private void setupTrack() {
		...
		/*
		 * canvas_g2.setColor(Color.gray); for(int i = 0; i < trackSize; i++
		 * ) { Point2D p1 = nodes[i].a; Point2D p2 = nodes[i].b;
		 * canvas_g2.drawLine((int)p1.x * 100, (int)p1.y * 100, (int)p2.x * 100,
		 * (int)p2.y * 100); }
		 */
		...
		for (int i = 0; i < trackSize; i++) {
			...
			canvas_g2.drawLine((int)(p1.x * 100), (int)(p1.y * 100), (int)(p2.x * 100), (int)(p2.y * 100));
			canvas_g2.fillOval((int)(p1.x * 100) - 15, (int)(p1.y * 100) - 15, 30, 30);
		}
		...
		for (int i = 0; i < trackSize; i++) {
			Point2D p = nodes[i].p;
			canvas_g2.fillOval((int)(p.x * 100) - 20, (int)(p.y * 100) - 20, 40, 40);
		}
